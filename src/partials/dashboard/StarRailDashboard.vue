...
<script>
import { useStarRailStore } from '/src/stores/StarRailStore';

export default {
  name: 'StarRailDashboard',
  computed: {
    jsonData() {
      return this.StarRailStore.jsonData;
    },
    loading() {
      return this.StarRailStore.loading;
    },
    error() {
      return this.StarRailStore.error;
    },
  },
  methods: {
    async fetchJsonData() {
      await this.StarRailStore.fetchJsonData();
    },
  },
  created() {
    this.fetchJsonData();
  ...
  setup() {
    const StarRailStore = useStarRailStore();
