...
<script>
import { useZenlessZoneZeroStore } from '/src/stores/ZenlessZoneZeroStore';

export default {
  name: 'ZenlessZoneZeroDashboard',
  computed: {
    jsonData() {
      return this.ZenlessZoneZeroStore.jsonData;
    },
    loading() {
      return this.ZenlessZoneZeroStore.loading;
    },
    error() {
      return this.ZenlessZoneZeroStore.error;
    },
  },
  methods: {
    async fetchJsonData() {
      await this.ZenlessZoneZeroStore.fetchJsonData();
    },
  },
  created() {
    this.fetchJsonData();
  ...
  setup() {
    const ZenlessZoneZeroStore = useZenlessZoneZeroStore();

    return {
      ZenlessZoneZeroStore,
    };
  },
};
</script>