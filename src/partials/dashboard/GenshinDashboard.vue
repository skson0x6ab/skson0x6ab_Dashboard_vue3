...
<script>
import { useGenshinStore } from '/src/stores/GenshinStore';

export default {
  name: 'GenshinDashboard',
  computed: {
    jsonData() {
      return this.GenshinStore.jsonData;
    },
    loading() {
      return this.GenshinStore.loading;
    },
    error() {
      return this.GenshinStore.error;
    },
  },
  methods: {
    async fetchJsonData() {
      await this.GenshinStore.fetchJsonData();
    },
  },
  created() {
    this.fetchJsonData();
